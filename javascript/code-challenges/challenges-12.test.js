...
const validatePin = (pin) => {
  ...
  // const validatePIN = (/^(\d{4})$/).test(pin);
  // return validatePIN;
};
...
If the word is between 5 and 10 characters long, regular expression. Otherwise, return false.
------------------------------------------------------------------------------------------------ */
...
const validateWord = (word) => {
  ...
  // const pattern = (/^[a-z]{5,10}$/i).test(word);
  // return pattern;
};
